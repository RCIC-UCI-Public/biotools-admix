...
## [Unreleased](https://github.com/RCIC-UCI-Public/biotools-admix/compare/2.5...HEAD)

### Commits

- update copyright [`34ec9f4`](https://github.com/RCIC-UCI-Public/biotools-admix/commit/34ec9f49ef24a4f5f09077968fb602b8d4c0f2c5)
- rm fossils [`3b9895f`](https://github.com/RCIC-UCI-Public/biotools-admix/commit/3b9895f0778b984b1741dd6d0eadc407154c22fb)
- use actual rpm size [`1b46b0f`](https://github.com/RCIC-UCI-Public/biotools-admix/commit/1b46b0fbd529e93650a6e6c53b9201ba93bec152)
- add admix expected rpms sizes [`3b4ff71`](https://github.com/RCIC-UCI-Public/biotools-admix/commit/3b4ff71a2460dd00aa956f1d81c5a82b0085ff32)
- ignore build stage directories [`16646fa`](https://github.com/RCIC-UCI-Public/biotools-admix/commit/16646fa6ca500026c04ecdfff9af16e740d45d17)
- fix edirect file name for the older version [`10e0902`](https://github.com/RCIC-UCI-Public/biotools-admix/commit/10e09023bc671d1bd3bbda10ef2b3b861f499000)
- nasm needed to compile isal. Uncovered this dependency because of admix [`67bb4b4`](https://github.com/RCIC-UCI-Public/biotools-admix/commit/67bb4b452dbfc01253e0ee9f4ba941e11943f369)
- The first statement of the description shdold be [`3fca3dd`](https://github.com/RCIC-UCI-Public/biotools-admix/commit/3fca3dd8d780cbb59a7b6340b2919b6482279daf)
- Remove older version of bustools. Unused, [`2fad59e`](https://github.com/RCIC-UCI-Public/biotools-admix/commit/2fad59eb57903edc5e4269f541f6728aebef2bb3)
- disable build of gatk v.4.1.9.0, it has log4 j security vulnerability. [`9e4cf0a`](https://github.com/RCIC-UCI-Public/biotools-admix/commit/9e4cf0a7b968d326ffa545c8c24600521727660b)
- grr... typo. I only can blame me. [`48ca1e0`](https://github.com/RCIC-UCI-Public/biotools-admix/commit/48ca1e02a6bbe75985555c59f2fe3dd65e66f496)
- Add ncbi-blast and ncbi-blast-module to centos8 bootstrap -- otherwise [`634d48e`](https://github.com/RCIC-UCI-Public/biotools-admix/commit/634d48e885f367281d8400d339052002faddd789)
- Fix typo { --&gt; {{ [`ec77515`](https://github.com/RCIC-UCI-Public/biotools-admix/commit/ec77515882cc754843d9ceec0987fef5cb5fc661)
- Add enablerepo: "epel" so that libeac will be installed [`8ec7e88`](https://github.com/RCIC-UCI-Public/biotools-admix/commit/8ec7e88769209981055a0de370ca9611a653fdfd)
- create base set, move everything from packages there [`4f409e5`](https://github.com/RCIC-UCI-Public/biotools-admix/commit/4f409e5ace67bf000916752566edda640ddefb55)
- Move repeatmasker and Text-Soundex back to base set and use ncbi [`9d1f0b7`](https://github.com/RCIC-UCI-Public/biotools-admix/commit/9d1f0b78dffbf7e8f6415416fabed0b0aff708f4)
- Need to install libaec from epel repo as dorado [`dcc2304`](https://github.com/RCIC-UCI-Public/biotools-admix/commit/dcc2304a88ad9f8617d911b4a0e162b389c491dc)
- Move Text-Soundex and repeatemasker to set-centos8. [`1e5301a`](https://github.com/RCIC-UCI-Public/biotools-admix/commit/1e5301a5b0b8bfb84f603b0fb255b0647c851b63)
- reset basic versions to what was on OS8 for the older compiler. [`b961576`](https://github.com/RCIC-UCI-Public/biotools-admix/commit/b96157608a4e73873822db582ac23429db451e82)
- needs to specify provides (compiled with newer gcc) [`46d3742`](https://github.com/RCIC-UCI-Public/biotools-admix/commit/46d37427ba5a7791e35850c042a25235a2155e05)
- use bindfs on  rocky9 [`8ca4d1f`](https://github.com/RCIC-UCI-Public/biotools-admix/commit/8ca4d1f6ed41120e8cc9e1988ff32530e77e3e33)
- use dynamic perl version [`21c3275`](https://github.com/RCIC-UCI-Public/biotools-admix/commit/21c3275550dd704367c6b0fca13e3e2f3b3260a9)
- ad admix name [`0dae8c0`](https://github.com/RCIC-UCI-Public/biotools-admix/commit/0dae8c06196b5e04a3ef2e3d095a478115895e23)
- rm fossils [`23ba637`](https://github.com/RCIC-UCI-Public/biotools-admix/commit/23ba63759b371e5c7c65cb82bf922bd7ddf9e7eb)
- combine group1 + group2 into a single set 2023 [`a4a5614`](https://github.com/RCIC-UCI-Public/biotools-admix/commit/a4a56149c87d4a9fdfa985c311bce1cac5a8275b)
- add dorado 0.9.1. Build rpm without build id links as they collide [`8828e6f`](https://github.com/RCIC-UCI-Public/biotools-admix/commit/8828e6fdb88dc63358821ddf6184e99a83b5e4ea)

## [2.5](https://github.com/RCIC-UCI-Public/biotools-admix/compare/2.0...2.5) - 2025-01-21

### Commits

- update CHANGELOG before tagging [`40a657d`](https://github.com/RCIC-UCI-Public/biotools-admix/commit/40a657dc08ab46866fcb5118817562d8af015d44)
